...
local function check_dependencies()
  ...
  if #missing > 0 then
    io.stderr:write(string.format(
      "Warning: Missing dependencies for exec-latex filter: %s\n",
...
function CodeBlock(block)
  ...
  local should_exec = block.attributes.exec == "true" or 
                      block.attributes.exec == "1" or
                      block.attributes.exec == "yes"
